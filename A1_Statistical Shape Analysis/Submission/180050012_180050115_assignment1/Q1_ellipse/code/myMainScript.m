...
imshow(I1+".jpg")
hold on
plot([shapes111(2, :, I1) shapes111(2, 1, I1)], [shapes111(1, :, I1) shapes111(1, 1, I1)], '-o', 'Color','r', "MarkerFaceColor",'r', 'LineWidth',2);
% plot1(m1, 'k');
...
imshow(I2+".jpg")
hold on
plot([shapes111(2, :, I2) shapes111(2, 1, I2)], [shapes111(1, :, I2) shapes111(1, 1, I2)], '-o', 'Color','r', "MarkerFaceColor",'r', 'LineWidth',2);
% plot1(msd1(:, 1), 'k');
...
imshow(I3+".jpg")
hold on
plot([shapes111(2, :, I3) shapes111(2, 1, I3)], [shapes111(1, :, I3) shapes111(1, 1, I3)], '-o', 'Color','r', "MarkerFaceColor",'r', 'LineWidth',2);
% plot1(msd2(:, 1), 'k');
title("pointset closest to mean-3*S.D.(Mean=black)");
f7 = figure(7);
f5 = figure(5);
